...
const  ErrorMsg = () =>  (
                          <div className="err-msg">
                           <span>
                        Test header must contain at least two charcters
                           </span>
                           </div>);
           ...
           <article className="mw15 center bg-blue br3 pa3 pa4-ns ma2 dib bw2 shadow-5">
              ...
              <div className= "txt-center">   
               <div className="tc center">
                 <input placeholder='Add here your quiz title' onChange={e=>serTempHeader(e.target.value)} className="first-step-input" /> 
             ...
             <div>
              <div className="txt-center">
               <img id="fileSelect" src={testImage} className="cursor-pointer br-100 h11 w11 dib ba b--black-05"  title="add your own image"  height={300} width={300} alt="test-image" />
               <FileUploader
                      id="fileElem"
